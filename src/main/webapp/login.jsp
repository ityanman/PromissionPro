                ...
                <div class="lg-box">
                    ...
                    <form>
                        <div class="lg-username input-item clearfix">
                            <i class="iconfont"></i>
                            <input type="text" value="ZHR" name="username" placeholder="请用户名">
                        </div>
...
<div class="login-ft">
    <div class="ft-inner">
        <div class="about-us">
            ...
            <a href="http://www.yansvip.com/">赵公子</a>
            <a href="javascript:;">服务条款</a>
            <a href="javascript:;">联系方式</a>
        </div>
        <div class="address"> 该内容版权均归 赵岩 所有 &nbsp;编号：210019&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2019&nbsp;-&nbsp;2020&nbsp;赵岩&nbsp;版权所有</div>
